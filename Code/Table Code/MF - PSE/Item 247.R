...
# item247.merge <- item247.merge[which(item247.merge$Category == "PSE"),]
# ######################################
...
# 
# exportTable(item247.table, "MF", "Table 39", weighted = TRUE,OS = T, osIndicator = "PSE")
# 
# #########################
# # weighted analysis
# #########################
...
# item247.table <- data.frame(item247.table)
# 
# exportTable(item247.table, "MF", "Table 39", weighted = FALSE,OS = T, osIndicator = "PSE")
