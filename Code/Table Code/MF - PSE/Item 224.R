...
item224.table <- data.frame("Nonresidential_Use_Type"  = item224.cast$Nonres.Type
                            ...
                            ,"PSE.King.County.n"           = item224.cast$`n_PSE KING COUNTY`
                            ...
                            ,"PSE.Non.King.County.n"       = item224.cast$`n_PSE NON-KING COUNTY`
                            ,"2017.RBSA.PS.Percent"        = item224.cast$`w.percent_2017 RBSA PS`
                            ,"2017.RBSA.PS.SE"             = item224.cast$`w.SE_2017 RBSA PS`
                            ,"2017.RBSA.PS.n"              = item224.cast$`n_2017 RBSA PS`
                            ,"PSE_EB"                      = item224.cast$EB_PSE
...
exportTable(item224.table, "MF", "Table 16", weighted = TRUE,OS = T, osIndicator = "PSE")
...
exportTable(item224.table, "MF", "Table 16", weighted = FALSE,OS = T, osIndicator = "PSE")
