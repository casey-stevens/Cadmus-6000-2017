...
exportTable(tableAJ.final.MF, "MF", "Table AJ", weighted = TRUE,OS = T, osIndicator = "PSE")
...
tableAJ.final.MF <- tableAJ.final.MF[which(tableAJ.final.MF$BuildingType == "Multifamily"),-1]
exportTable(tableAJ.final.MF, "MF", "Table AJ", weighted = FALSE,OS = T, osIndicator = "PSE")
