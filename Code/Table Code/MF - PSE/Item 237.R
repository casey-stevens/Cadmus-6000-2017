...
item237A.table <- data.frame("BuildingType"                   = item237A.cast$BuildingType
                            ...
                            ,"Percent.R41.R50"               = NA#item237A.cast$w.percent_R41.R50
                            ,"SE.R41.R50"                    = NA#item237A.cast$w.SE_R41.R50
                            ...
                            ,"EB.R41.R50"                    = NA#item237A.cast$EB_R41.R50
...
item237A.table <- data.frame("BuildingType"                   = item237A.cast$BuildingType
                            ...
                            ,"Percent.R41.R50"               = NA#item237A.cast$Percent_R41.R50
                            ,"SE.R41.R50"                    = NA#item237A.cast$SE_R41.R50
