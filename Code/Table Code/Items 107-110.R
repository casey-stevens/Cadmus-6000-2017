...
item107.dat1 <- left_join(item107.dat0, rbsa.dat, by = "CK_Cadmus_ID")

item107.dat2 <- item107.dat1[which(item107.dat1$Type == "Television"),]
...
item109.dat4$TV.Screen.Type[grep("CRT",item109.dat4$TV.Screen.Type)] <- "CRT"
