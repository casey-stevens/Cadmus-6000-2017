...
unique(prep.dat1.0$Wall.Cavity.Insulation.Type.2)
unique(prep.dat1.0$Wall.Cavity.Insulation.Type.3) #nothing in this column
unique(prep.dat1.0$Wall.Exterior.Insulation.Type.1)
unique(prep.dat1.0$Wall.Exterior.Insulation.Type.2) #nothing in this column
unique(prep.dat1.0$Wall.Exterior.Insulation.Type.3) #nothing in this column
unique(prep.dat1.0$Furred.Wall.Insulation.Type)
  
#review insulation thicknesses
unique(prep.dat1.0$Wall.Cavity.Insulation.Thickness.1)
unique(prep.dat1.0$Wall.Cavity.Insulation.Thickness.2)
unique(prep.dat1.0$Wall.Cavity.Insulation.Thickness.3)
unique(prep.dat1.0$Wall.Exterior.Insulation.Thickness.1)
unique(prep.dat1.0$Wall.Exterior.Insulation.Thickness.2)
unique(prep.dat1.0$Wall.Exterior.Insulation.Thickness.3)
unique(prep.dat1.0$Furred.Wall.Insulation.Thickness)

#review conditions
unique(prep.dat1.0$Wall.Cavity.Insulation.Condition.1)
unique(prep.dat1.0$Wall.Cavity.Insulation.Condition.2)
unique(prep.dat1.0$Wall.Cavity.Insulation.Condition.3)
unique(prep.dat1.0$Wall.Exterior.Insulation.Condition.1)
unique(prep.dat1.0$Wall.Exterior.Insulation.Condition.2)
unique(prep.dat1.0$Wall.Exterior.Insulation.Condition.3)
unique(prep.dat1.0$Wall.Type)
...
prep.dat3$Wall.Cavity.Insulation.Thickness.1[which(prep.dat3$Wall.Cavity.Insulation.Thickness.1 == "Unknown")] <- "Unknown Unknown"
...
#cleaning for furred wall
prep.dat3$Furred.Wall.Insulation.Thickness[which(prep.dat3$Furred.Wall.Insulation.Thickness == "N/A")] <- "N/A N/A"
prep.dat3$Furred.Wall.Insulation.Thickness[which(is.na(prep.dat3$Furred.Wall.Insulation.Thickness))] <- "N/A N/A"
prep.dat3$Furred.Wall.Insulation.Thickness[which(prep.dat3$Furred.Wall.Insulation.Thickness == "Unknown")] <- "N/A N/A"
prep.dat3$Furred.Wall.Insulation.Thickness[which(prep.dat3$Furred.Wall.Insulation.Thickness == "10in")] <- "10 inches"
prep.dat3$Furred.Wall.Insulation.Thickness[which(prep.dat3$Furred.Wall.Insulation.Thickness == "1.5")] <- "1.5 inches"
unique(prep.dat3$Furred.Wall.Insulation.Thickness)
...
clean.insul.furred0 <- unlist(strsplit(prep.dat3$Furred.Wall.Insulation.Thickness, " "))
clean.insul.furred00 <- as.data.frame(matrix(clean.insul.furred0, ncol = 2, byrow = T), stringsAsFactors = F)
clean.insul.furred2 <- cbind.data.frame("CK_Cadmus_ID" = prep.dat3$CK_Cadmus_ID
                                        ,"CK_Building_ID" = prep.dat3$CK_SiteID
                                   , "TMP_ID" = prep.dat3$TMP_ID
                                   , clean.insul.furred00)
dim(clean.insul.furred2)

clean.insul.join1 <- left_join(clean.insul1.1,    clean.insul2.1, by = c("CK_Cadmus_ID","CK_Building_ID", "TMP_ID"))
clean.insul.join2 <- left_join(clean.insul.join1, clean.insul3.1, by = c("CK_Cadmus_ID","CK_Building_ID", "TMP_ID"))
clean.insul.join3 <- left_join(clean.insul.join2, clean.insul1.2, by = c("CK_Cadmus_ID","CK_Building_ID", "TMP_ID"))
clean.insul.join4 <- left_join(clean.insul.join3, clean.insul2.2, by = c("CK_Cadmus_ID","CK_Building_ID", "TMP_ID"))
clean.insul.join5 <- left_join(clean.insul.join4, clean.insul3.2, by = c("CK_Cadmus_ID","CK_Building_ID", "TMP_ID"))
clean.insul.join6 <- left_join(clean.insul.join5, clean.insul.furred2, by = c("CK_Cadmus_ID","CK_Building_ID", "TMP_ID"))

colnames(clean.insul.join6) <- c("CK_Cadmus_ID"
                                 ,"CK_SiteID"
                                 ,"TMP_ID"
                                 ,"cavity.inches1"
                                 ,"Remove.1"
...
prep.dat4$furred.inches    <- as.numeric(as.character(prep.dat4$furred.inches))
...
#merge weighted u values onto cleaned RBSA data
item10.os.dat2 <- left_join(item10.os.dat1, rbsa.dat.orig)
item10.os.dat2$aveUval[which(is.na(item10.os.dat2$aveUval))] <- 0
item10.os.dat2$aveRval[which(is.na(item10.os.dat2$aveRval))] <- 0
item10.os.dat2 <- item10.os.dat2[which(item10.os.dat2$CK_Building_ID == "SCL GenPop"),]
...
item10.os.merge <- left_join(rbsa.dat.orig, item10.os.dat3)
...
#export table to correct workbook using exporting function
exportTable(item10.os.table.SF, "SF", "Table 17", weighted = TRUE, osIndicator = "SCL", OS = T)
...
#export table to correct workbook using exporting function
exportTable(item10.os.table.SF, "SF", "Table 17", weighted = FALSE, osIndicator = "SCL", OS = T)
...
item11.os.dat2 <- left_join(item11.os.dat1, rbsa.dat.orig, by = c("CK_Cadmus_ID"))
item11.os.dat2 <- item11.os.dat2[which(item11.os.dat2$CK_Building_ID == "SCL GenPop"),]
#remove unneccesary wall types
...
item11.os.merge <- left_join(rbsa.dat.orig, item11.os.customer)
...
#export table to correct workbook using exporting function
exportTable(item11.os.table.SF, "SF", "Table 18", weighted = TRUE, osIndicator = "SCL", OS = T)
...
#export table to correct workbook using exporting function
exportTable(item11.os.table.SF, "SF", "Table 18", weighted = FALSE, osIndicator = "SCL", OS = T)
...
item11A.os.dat2 <- left_join(item11A.os.dat1, rbsa.dat.orig, by = c("CK_Cadmus_ID"))
...
item11A.os.merge <- left_join(rbsa.dat.orig, item11A.os.customer)
...
item11A.os.cast <- dcast(setDT(item11A.os.final),
                        formula   = BuildingType +  CK_Building_ID ~ Wall.Type, sum,
                        value.var = c("w.percent", "w.SE", "count","n","N","EB"))



item11A.os.table <- data.frame("BuildingType"    = item11A.os.cast$BuildingType
                              ,"Sample"          = item11A.os.cast$CK_Building_ID
                              ,"Percent_2x4"     = item11A.os.cast$`w.percent_Framed 2x4`
                              ,"SE_2x4"          = item11A.os.cast$`w.SE_Framed 2x4`
                              ,"Percent_2x6"     = item11A.os.cast$`w.percent_Framed 2x6`
                              ,"SE_2x6"          = item11A.os.cast$`w.SE_Framed 2x6`
                              # ,"Percent_2x8"     = item11A.os.cast$`w.percent_Framed 2x8`
                              # ,"SE_2x8"          = item11A.os.cast$`w.SE_Framed 2x8`
                              ,"Percent_ALT"     = item11A.os.cast$w.percent_Alternative
                              ,"SE_ALT"          = item11A.os.cast$w.SE_Alternative
                              ,"Percent_Unknown" = item11A.os.cast$`w.percent_Framed (Unknown)`
                              ,"SE_Unknown"      = item11A.os.cast$`w.SE_Framed (Unknown)`
                              ,"n"               = item11A.os.cast$n_Total
                              ,"EB_2x4"          = item11A.os.cast$`EB_Framed 2x4`
                              ,"EB_2x6"          = item11A.os.cast$`EB_Framed 2x6`
                              # ,"EB_2x6"          = item11A.os.cast$`EB_Framed 2x8`
                              ,"EB_ALT"          = item11A.os.cast$EB_Alternative
                              ,"EB_Unknown"      = item11A.os.cast$`EB_Framed (Unknown)`
)

# row ordering example code
unique(item11A.os.table$Sample)
rowOrder <- c("SCL GenPop"
              ,"SCL LI"
              ,"SCL EH"
              ,"2017 RBSA PS")
item11A.os.table <- item11A.os.table %>% mutate(Sample = factor(Sample, levels = rowOrder)) %>% arrange(Sample)  
...
#export table to correct workbook using exporting function
exportTable(item11A.os.table.SF, "SF", "Table 18A", weighted = TRUE, osIndicator = "SCL", OS = T)
...
item11A.os.table <- data.frame("BuildingType"    = item11A.os.cast$BuildingType
                              ,"Sample"          = item11A.os.cast$CK_Building_ID
                              ,"Percent_2x4"     = item11A.os.cast$`Percent_Framed 2x4`
                              ,"SE_2x4"          = item11A.os.cast$`SE_Framed 2x4`
                              ,"Percent_2x6"     = item11A.os.cast$`Percent_Framed 2x6`
                              ,"SE_2x6"          = item11A.os.cast$`SE_Framed 2x6`
                              # ,"Percent_2x8"     = item11A.os.cast$`Percent_Framed 2x8`
                              # ,"SE_2x8"          = item11A.os.cast$`SE_Framed 2x8`
                              ,"Percent_ALT"     = item11A.os.cast$Percent_Alternative
                              ,"SE_ALT"          = item11A.os.cast$SE_Alternative
                              ,"Percent_Unknown" = item11A.os.cast$`Percent_Framed (Unknown)`
                              ,"SE_Unknown"      = item11A.os.cast$`SE_Framed (Unknown)`
                              ,"n"               = item11A.os.cast$n_Total
)
...
#export table to correct workbook using exporting function
exportTable(item11A.os.table.SF, "SF", "Table 18A", weighted = FALSE, osIndicator = "SCL", OS = T)
...
#merge weighted u values onto cleaned RBSA data
prep.tableAP.dat2 <- left_join(prep.tableAP.dat1, rbsa.dat.orig)
prep.tableAP.dat2$aveUval[which(is.na(prep.tableAP.dat2$aveUval))] <- 0
prep.tableAP.dat2$aveRval[which(is.na(prep.tableAP.dat2$aveRval))] <- 0
...
tableAP.merge <- left_join(rbsa.dat.orig, tableAP.dat1)
tableAP.merge <- tableAP.merge[which(!is.na(tableAP.merge$count)),]
...
#export table to correct workbook using exporting function
exportTable(tableAP.table.SF, "SF", "Table AP", weighted = TRUE, osIndicator = "SCL", OS = T)
...
#export table to correct workbook using exporting function
exportTable(tableAP.table.SF, "SF", "Table AP", weighted = FALSE, osIndicator = "SCL", OS = T)
...
#merge weighted u values onto cleaned RBSA data
prep.item12.os.dat2 <- left_join(prep.item12.os.dat1, rbsa.dat.orig)
...
item12.os.merge <- left_join(rbsa.dat.orig, item12.os.dat1)
...
item12.os.data1 <- item12.os.data[which(item12.os.data$CK_Building_ID == "SCL GenPop"),]
################################################
# Weighted Analysis - Single Family
################################################
...
#export table to correct workbook using exporting function
exportTable(item12.os.table.SF, "SF", "Table 19", weighted = TRUE)
...
#export table to correct workbook using exporting function
exportTable(item12.os.table.SF, "SF", "Table 19", weighted = FALSE)
...
item14.os.table <- data.frame("BuildingType"     = item14.os.cast$BuildingType
                           ...
                           ,"Percent.RGT22"   = 0#item14.os.cast$w.percent_RGT22
                           ,"SE.RGT22"        = 0#item14.os.cast$w.SE_RGT22
                           ...
                           ,"EB.RGT22"        = 0#item14.os.cast$EB_RGT22
)
...
#export table to correct workbook using exporting function
exportTable(item14.os.table.SF, "SF", "Table 21", weighted = TRUE, osIndicator = "SCL", OS = T)
...
item14.os.table <- data.frame("BuildingType"     = item14.os.cast$BuildingType
                           ...
                           ,"Percent.RGT22"   = 0#item14.os.cast$Percent_RGT22
                           ,"SE.RGT22"        = 0#item14.os.cast$SE_RGT22
                           ,"n" = item14.os.cast$`n_All Housing Vintages`
)
...
#export table to correct workbook using exporting function
exportTable(item14.os.table.SF, "SF", "Table 21", weighted = FALSE, osIndicator = "SCL", OS = T)
...
item15.os.table <- data.frame("BuildingType"     = item15.os.cast$BuildingType
                           ...
                           ,"Percent.RGT22"   = 0#item15.os.cast$w.percent_RGT22
                           ,"SE.RGT22"        = 0#item15.os.cast$w.SE_RGT22
                           ...
                           ,"EB.RGT22"        = 0#item15.os.cast$EB_RGT22
)
...
#export table to correct workbook using exporting function
exportTable(item15.os.table.SF, "SF", "Table 22", weighted = TRUE, osIndicator = "SCL", OS = T)
...
item15.os.table <- data.frame("BuildingType"     = item15.os.cast$BuildingType
                           ...
                           ,"Percent.RGT22"   = 0#item15.os.cast$Percent_RGT22
                           ,"SE.RGT22"        = 0#item15.os.cast$SE_RGT22
                           ,"n" = item15.os.cast$`n_All Housing Vintages`
)
...
#export table to correct workbook using exporting function
exportTable(item15.os.table.SF, "SF", "Table 22", weighted = FALSE, osIndicator = "SCL", OS = T)
...
#############################################################################################
# Item 16: DISTRIBUTION OF WALL INSULATION LEVELS BY HOME VINTAGE, 2017 RBSA PUGET SOUND  (SF table 23)
#############################################################################################
## Note: For this table, you must run up to item12.os.dat1 for the cleaned data
...
#export table to correct workbook using exporting function
exportTable(item16.os.table.SF, "SF", "Table 23", weighted = TRUE, osIndicator = "SCL", OS = T)
...
#export table to correct workbook using exporting function
exportTable(item16.os.table.SF, "SF", "Table 23", weighted = FALSE, osIndicator = "SCL", OS = T)
...
item18.os.merge <- left_join(rbsa.dat.orig, item18.os.dat)
item18.os.merge <- item18.os.merge[which(item18.os.merge$CK_Building_ID == "SCL GenPop"),]
...
item18.os.merge <- left_join(rbsa.dat.orig, item18.os.customer)
...
#export table to correct workbook using exporting function
exportTable(item18.os.table.SF, "SF", "Table 25", weighted = TRUE, osIndicator = "SCL", OS = T)
...
#export table to correct workbook using exporting function
exportTable(item18.os.table.SF, "SF", "Table 25", weighted = FALSE, osIndicator = "SCL", OS = T)
...
#merge weighted u values onto cleaned RBSA data
item17.os.dat2 <- left_join(item17.os.dat1, rbsa.dat.orig)
item17.os.dat2$aveUval[which(is.na(item17.os.dat2$aveUval))] <- 0
item17.os.dat2$aveRval[which(is.na(item17.os.dat2$aveRval))] <- 0
item17.os.dat2 <- item17.os.dat2[which(item17.os.dat2$CK_Building_ID == "SCL GenPop"),]
...
item17.os.merge <- left_join(rbsa.dat.orig, item17.os.dat3)
...
#export table to correct workbook using exporting function
exportTable(item17.os.table.SF, "SF", "Table 24", weighted = TRUE, osIndicator = "SCL", OS = T)
...
#export table to correct workbook using exporting function
exportTable(item17.os.table.SF, "SF", "Table 24", weighted = FALSE, osIndicator = "SCL", OS = T)
...
#merge weighted u values onto cleaned RBSA data
item17A.os.dat2 <- left_join(item17A.os.dat1, rbsa.dat.orig)
...
item17A.os.merge <- left_join(rbsa.dat.orig, item17A.os.dat3)
...
item17A.os.cast <- dcast(setDT(item17A.os.final),
                        formula   = BuildingType +  CK_Building_ID ~ rvalue.bins,
                        value.var = c("w.percent", "w.SE", "count", "n", "N", "EB"))

#join all insulation levels onto rvalue summary
item17A.os.table <- data.frame("BuildingType"     = item17A.os.cast$BuildingType
                              ,"Sample"           = item17A.os.cast$CK_Building_ID
                              ,"Percent.None"     = item17A.os.cast$w.percent_None
                              ,"SE.None"          = item17A.os.cast$w.SE_None
                              ,"Percent.R1.R9"    = item17A.os.cast$w.percent_R1.R9
                              ,"SE.R1.R9"         = item17A.os.cast$w.SE_R1.R9
                              ,"Percent.R10.R15"  = item17A.os.cast$w.percent_R10.R15
                              ,"SE.R10.R15"       = item17A.os.cast$w.SE_R10.R15
                              ,"Percent.R16.R20"  = item17A.os.cast$w.percent_R16.R20
                              ,"SE.R16.R20"       = item17A.os.cast$w.SE_R16.R20
                              ,"Percent.RGT21"    = item17A.os.cast$w.percent_RGT21
                              ,"SE.RGT21"         = item17A.os.cast$w.SE_RGT21
                              ,"n"                = item17A.os.cast$`n_All Insulation Levels`
                              ,'EB.None'          = item17A.os.cast$EB_None
                              ,"EB.R1.R9"         = item17A.os.cast$EB_R1.R9
                              ,"EB.R10.R15"       = item17A.os.cast$EB_R10.R15
                              ,"EB.R16.R20"       = item17A.os.cast$EB_R16.R20
                              ,"EB.R21"           = item17A.os.cast$EB_RGT21
)

# row ordering example code
levels(item17A.os.table$Sample)
rowOrder <- c("SCL GenPop"
              ,"SCL LI"
              ,"SCL EH"
              ,"2017 RBSA PS")
item17A.os.table <- item17A.os.table %>% mutate(Sample = factor(Sample, levels = rowOrder)) %>% arrange(Sample)  
...
#export table to correct workbook using exporting function
exportTable(item17A.os.table.SF, "SF", "Table 24A", weighted = TRUE, osIndicator = "SCL", OS = T)
...
item17A.os.table <- data.frame("BuildingType"     = item17A.os.cast$BuildingType
                               ,"Sample"          = item17A.os.cast$CK_Building_ID
                               ,"Percent.None"    = item17A.os.cast$Percent_None
                               ,"SE.None"         = item17A.os.cast$SE_None
                               ,"Percent.R1.R9"   = item17A.os.cast$Percent_R1.R9
                               ,"SE.R1.R9"        = item17A.os.cast$SE_R1.R9
                               ,"Percent.R10.R15" = item17A.os.cast$Percent_R10.R15
                               ,"SE.R10.R15"      = item17A.os.cast$SE_R10.R15
                               ,"Percent.R16.R20" = item17A.os.cast$Percent_R16.R20
                               ,"SE.R16.R20"      = item17A.os.cast$SE_R16.R20
                               ,"Percent.RGT21"   = item17A.os.cast$Percent_RGT21
                               ,"SE.RGT21"        = item17A.os.cast$SE_RGT21
                               ,"n"               = item17A.os.cast$`n_All Insulation Levels`
)
...
#export table to correct workbook using exporting function
exportTable(item17A.os.table.SF, "SF", "Table 24A", weighted = FALSE, osIndicator = "SCL", OS = T)
